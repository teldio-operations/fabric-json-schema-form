 ...
 * 
 * @export
 * @interface DevelopmentLicense
 */
export interface DevelopmentLicense {
    [key: string]: any | any;
    /**
     * 
     * @type {Date}
     * @memberof DevelopmentLicense
     */
    expiry: Date;
}

/**
 * Check if a given object implements the DevelopmentLicense interface.
 */
export function instanceOfDevelopmentLicense(value: object): value is DevelopmentLicense {
    if (!('expiry' in value) || value['expiry'] === undefined) return false;
    return true;
}

export function DevelopmentLicenseFromJSON(json: any): DevelopmentLicense {
    return DevelopmentLicenseFromJSONTyped(json, false);
}

export function DevelopmentLicenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DevelopmentLicense {
    if (json == null) {
        return json;
    }
    return {
...
export function DevelopmentLicenseToJSON(json: any): DevelopmentLicense {
    return DevelopmentLicenseToJSONTyped(json, false);
}

export function DevelopmentLicenseToJSONTyped(value?: DevelopmentLicense | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
