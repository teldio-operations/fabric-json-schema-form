 ...
 * 
 * @export
 * @interface UnapprovedModule
 */
export interface UnapprovedModule {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof UnapprovedModule
     */
    basename: string;
    /**
     * 
...
/**
 * Check if a given object implements the UnapprovedModule interface.
 */
export function instanceOfUnapprovedModule(value: object): value is UnapprovedModule {
    if (!('basename' in value) || value['basename'] === undefined) return false;
    if (!('path' in value) || value['path'] === undefined) return false;
    return true;
}

export function UnapprovedModuleFromJSON(json: any): UnapprovedModule {
    return UnapprovedModuleFromJSONTyped(json, false);
}

export function UnapprovedModuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnapprovedModule {
    if (json == null) {
        return json;
    }
    return {
...
export function UnapprovedModuleToJSON(json: any): UnapprovedModule {
    return UnapprovedModuleToJSONTyped(json, false);
}

export function UnapprovedModuleToJSONTyped(value?: UnapprovedModule | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
