...
import {
    LicenseV1FromJSON,
    LicenseV1FromJSONTyped,
    LicenseV1ToJSON,
    LicenseV1ToJSONTyped,
} from './LicenseV1';
...
/**
 * Check if a given object implements the LicenseClaims interface.
 */
export function instanceOfLicenseClaims(value: object): value is LicenseClaims {
...
export function LicenseClaimsFromJSON(json: any): LicenseClaims {
    return LicenseClaimsFromJSONTyped(json, false);
}

export function LicenseClaimsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LicenseClaims {
    if (json == null) {
        return json;
    }
    return {
        ...
        'v1': json['v1'] == null ? undefined : LicenseV1FromJSON(json['v1']),
        'version': json['version'],
    };
}

export function LicenseClaimsToJSON(json: any): LicenseClaims {
    return LicenseClaimsToJSONTyped(json, false);
}

export function LicenseClaimsToJSONTyped(value?: LicenseClaims | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
