 ...
 * 
 * @export
 * @interface RestartResponseBody
 */
export interface RestartResponseBody {
    [key: string]: any | any;
    /**
     * A URL to the JSON Schema for this object.
     * @type {string}
     * @memberof RestartResponseBody
     */
...
/**
 * Check if a given object implements the RestartResponseBody interface.
 */
export function instanceOfRestartResponseBody(value: object): value is RestartResponseBody {
    if (!('managerUrl' in value) || value['managerUrl'] === undefined) return false;
    return true;
}

export function RestartResponseBodyFromJSON(json: any): RestartResponseBody {
    return RestartResponseBodyFromJSONTyped(json, false);
}

export function RestartResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RestartResponseBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'managerUrl': json['managerUrl'],
    };
}

export function RestartResponseBodyToJSON(json: any): RestartResponseBody {
    return RestartResponseBodyToJSONTyped(json, false);
}

export function RestartResponseBodyToJSONTyped(value?: Omit<RestartResponseBody, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
