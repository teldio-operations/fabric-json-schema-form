...
import type { DemoLicense } from './DemoLicense';
import {
    DemoLicenseFromJSON,
    DemoLicenseFromJSONTyped,
    DemoLicenseToJSON,
    DemoLicenseToJSONTyped,
} from './DemoLicense';
import type { PerpetualLicense } from './PerpetualLicense';
import {
    PerpetualLicenseFromJSON,
    PerpetualLicenseFromJSONTyped,
    PerpetualLicenseToJSON,
    PerpetualLicenseToJSONTyped,
} from './PerpetualLicense';
import type { DevelopmentLicense } from './DevelopmentLicense';
import {
    DevelopmentLicenseFromJSON,
    DevelopmentLicenseFromJSONTyped,
    DevelopmentLicenseToJSON,
    DevelopmentLicenseToJSONTyped,
} from './DevelopmentLicense';
...
export interface LicenseV1 {
    ...
    /**
     * 
     * @type {DevelopmentLicense}
     * @memberof LicenseV1
     */
    development?: DevelopmentLicense;
    /**
     * 
     * @type {string}
     * @memberof LicenseV1
...
/**
 * Check if a given object implements the LicenseV1 interface.
 */
export function instanceOfLicenseV1(value: object): value is LicenseV1 {
    if (!('hardwareId' in value) || value['hardwareId'] === undefined) return false;
    if (!('storedToken' in value) || value['storedToken'] === undefined) return false;
    return true;
}

export function LicenseV1FromJSON(json: any): LicenseV1 {
    return LicenseV1FromJSONTyped(json, false);
}

export function LicenseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): LicenseV1 {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'demo': json['demo'] == null ? undefined : DemoLicenseFromJSON(json['demo']),
        'development': json['development'] == null ? undefined : DevelopmentLicenseFromJSON(json['development']),
        'hardwareId': json['hardwareId'],
        'perpetual': json['perpetual'] == null ? undefined : PerpetualLicenseFromJSON(json['perpetual']),
        'storedToken': json['storedToken'],
    };
}

export function LicenseV1ToJSON(json: any): LicenseV1 {
    return LicenseV1ToJSONTyped(json, false);
}

export function LicenseV1ToJSONTyped(value?: LicenseV1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'demo': DemoLicenseToJSON(value['demo']),
        'development': DevelopmentLicenseToJSON(value['development']),
        'hardwareId': value['hardwareId'],
        'perpetual': PerpetualLicenseToJSON(value['perpetual']),
        'storedToken': value['storedToken'],
    };
}
