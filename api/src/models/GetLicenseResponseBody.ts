...
import type { LicenseClaims } from './LicenseClaims';
import {
    LicenseClaimsFromJSON,
    LicenseClaimsFromJSONTyped,
    LicenseClaimsToJSON,
    LicenseClaimsToJSONTyped,
} from './LicenseClaims';

/**
 * 
 * @export
 * @interface GetLicenseResponseBody
 */
export interface GetLicenseResponseBody {
    [key: string]: any | any;
    /**
     * A URL to the JSON Schema for this object.
     * @type {string}
     * @memberof GetLicenseResponseBody
     */
...
/**
 * Check if a given object implements the GetLicenseResponseBody interface.
 */
export function instanceOfGetLicenseResponseBody(value: object): value is GetLicenseResponseBody {
    return true;
}

export function GetLicenseResponseBodyFromJSON(json: any): GetLicenseResponseBody {
    return GetLicenseResponseBodyFromJSONTyped(json, false);
}

export function GetLicenseResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLicenseResponseBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'configuredModules': json['configuredModules'] == null ? undefined : json['configuredModules'],
        'expiry': json['expiry'] == null ? undefined : (new Date(json['expiry'])),
        'license': json['license'] == null ? undefined : LicenseClaimsFromJSON(json['license']),
        'licenseError': json['licenseError'] == null ? undefined : json['licenseError'],
        'licenseWarning': json['licenseWarning'] == null ? undefined : json['licenseWarning'],
        'shortError': json['shortError'] == null ? undefined : json['shortError'],
    };
}

export function GetLicenseResponseBodyToJSON(json: any): GetLicenseResponseBody {
    return GetLicenseResponseBodyToJSONTyped(json, false);
}

export function GetLicenseResponseBodyToJSONTyped(value?: Omit<GetLicenseResponseBody, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'configuredModules': value['configuredModules'],
        'expiry': value['expiry'] == null ? value['expiry'] : value['expiry'].toISOString(),
        'license': LicenseClaimsToJSON(value['license']),
        'licenseError': value['licenseError'],
        'licenseWarning': value['licenseWarning'],
        'shortError': value['shortError'],
    };
}
