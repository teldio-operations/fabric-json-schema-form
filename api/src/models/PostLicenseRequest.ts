...
/**
 * Check if a given object implements the PostLicenseRequest interface.
 */
export function instanceOfPostLicenseRequest(value: object): value is PostLicenseRequest {
    if (!('license' in value) || value['license'] === undefined) return false;
    return true;
}

export function PostLicenseRequestFromJSON(json: any): PostLicenseRequest {
    return PostLicenseRequestFromJSONTyped(json, false);
}

export function PostLicenseRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostLicenseRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostLicenseRequestToJSON(json: any): PostLicenseRequest {
    return PostLicenseRequestToJSONTyped(json, false);
}

export function PostLicenseRequestToJSONTyped(value?: Omit<PostLicenseRequest, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
