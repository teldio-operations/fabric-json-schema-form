...
/**
 * Check if a given object implements the PostConfigBody interface.
 */
export function instanceOfPostConfigBody(value: object): value is PostConfigBody {
    if (!('id' in value) || value['id'] === undefined) return false;
    return true;
}

export function PostConfigBodyFromJSON(json: any): PostConfigBody {
    return PostConfigBodyFromJSONTyped(json, false);
}

export function PostConfigBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostConfigBody {
    if (json == null) {
        return json;
    }
    return {
...
export function PostConfigBodyToJSON(json: any): PostConfigBody {
    return PostConfigBodyToJSONTyped(json, false);
}

export function PostConfigBodyToJSONTyped(value?: Omit<PostConfigBody, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
