...
export interface GetMeBody {
     ...
     * @memberof GetMeBody
     */
    permissions?: Array<GetMeBodyPermissionsEnum> | null;
    /**
     * 
     * @type {string}
     * @memberof GetMeBody
 ...
 * @export
 */
export const GetMeBodyPermissionsEnum = {
    SettingsUsersManage: 'settings/users:manage',
    ModulesManage: 'modules:manage',
    SettingsManage: 'settings:manage'
} as const;
export type GetMeBodyPermissionsEnum = typeof GetMeBodyPermissionsEnum[keyof typeof GetMeBodyPermissionsEnum];


/**
 * Check if a given object implements the GetMeBody interface.
 */
export function instanceOfGetMeBody(value: object): value is GetMeBody {
    if (!('username' in value) || value['username'] === undefined) return false;
    return true;
}

export function GetMeBodyFromJSON(json: any): GetMeBody {
    return GetMeBodyFromJSONTyped(json, false);
}

export function GetMeBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetMeBody {
    if (json == null) {
        return json;
    }
    return {
...
export function GetMeBodyToJSON(json: any): GetMeBody {
    return GetMeBodyToJSONTyped(json, false);
}

export function GetMeBodyToJSONTyped(value?: Omit<GetMeBody, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
