...
import type { Event2Data } from './Event2Data';
import {
    Event2DataFromJSON,
    Event2DataFromJSONTyped,
    Event2DataToJSON,
    Event2DataToJSONTyped,
} from './Event2Data';
...
export interface Event2 {
    ...
    data?: Event2Data;
    /**
     * The event name. Deprecated because EventSource doesn't allow reading all messages. Use the `meta.eventName` field instead.
     * @type {string}
     * @memberof Event2
     * @deprecated
     */
...
/**
 * Check if a given object implements the Event2 interface.
 */
export function instanceOfEvent2(value: object): value is Event2 {
    return true;
}
...
export function Event2FromJSONTyped(json: any, ignoreDiscriminator: boolean): Event2 {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : Event2DataFromJSON(json['data']),
...
export function Event2ToJSON(json: any): Event2 {
    return Event2ToJSONTyped(json, false);
}

export function Event2ToJSONTyped(value?: Event2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': Event2DataToJSON(value['data']),
        'event': value['event'],
        'id': value['id'],
        'retry': value['retry'],
    };
