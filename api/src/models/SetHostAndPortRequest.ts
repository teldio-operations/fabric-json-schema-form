 ...
 * 
 * @export
 * @interface SetHostAndPortRequest
 */
export interface SetHostAndPortRequest {
    [key: string]: any | any;
    /**
     * A URL to the JSON Schema for this object.
     * @type {string}
     * @memberof SetHostAndPortRequest
     */
...
/**
 * Check if a given object implements the SetHostAndPortRequest interface.
 */
export function instanceOfSetHostAndPortRequest(value: object): value is SetHostAndPortRequest {
    if (!('host' in value) || value['host'] === undefined) return false;
    if (!('port' in value) || value['port'] === undefined) return false;
    return true;
}

export function SetHostAndPortRequestFromJSON(json: any): SetHostAndPortRequest {
    return SetHostAndPortRequestFromJSONTyped(json, false);
}

export function SetHostAndPortRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetHostAndPortRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SetHostAndPortRequestToJSON(json: any): SetHostAndPortRequest {
    return SetHostAndPortRequestToJSONTyped(json, false);
}

export function SetHostAndPortRequestToJSONTyped(value?: Omit<SetHostAndPortRequest, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
