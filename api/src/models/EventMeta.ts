...
export interface EventMeta {
    /**
     * The ID of this event as UUIDv4.
     * @type {string}
     * @memberof EventMeta
     */
    eventId: string;
    ...
    eventName: string;
    /**
     * The ID of another event that this one is a reply to.
     * @type {string}
     * @memberof EventMeta
     */
    replyToId?: string;
    /**
     * A module's unique identifier. UUIDv4 should be used when the identity of a module is not important.
     * @type {string}
     * @memberof EventMeta
     */
...
/**
 * Check if a given object implements the EventMeta interface.
 */
export function instanceOfEventMeta(value: object): value is EventMeta {
...
export function EventMetaFromJSON(json: any): EventMeta {
    return EventMetaFromJSONTyped(json, false);
}

export function EventMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventMeta {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sourceModuleId': json['sourceModuleId'] == null ? undefined : json['sourceModuleId'],
        'sourceModuleName': json['sourceModuleName'] == null ? undefined : json['sourceModuleName'],
        'targetModuleId': json['targetModuleId'] == null ? undefined : json['targetModuleId'],
        'targetModuleName': json['targetModuleName'] == null ? undefined : json['targetModuleName'],
        'time': (new Date(json['time'])),
    };
}

export function EventMetaToJSON(json: any): EventMeta {
    return EventMetaToJSONTyped(json, false);
}

export function EventMetaToJSONTyped(value?: EventMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sourceModuleName': value['sourceModuleName'],
        'targetModuleId': value['targetModuleId'],
        'targetModuleName': value['targetModuleName'],
