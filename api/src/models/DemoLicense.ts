...
export interface DemoLicense {
     ...
     * 
     * @type {Date}
     * @memberof DemoLicense
     */
    expiry: Date;
}

/**
 * Check if a given object implements the DemoLicense interface.
 */
export function instanceOfDemoLicense(value: object): value is DemoLicense {
    if (!('expiry' in value) || value['expiry'] === undefined) return false;
    return true;
}

export function DemoLicenseFromJSON(json: any): DemoLicense {
    return DemoLicenseFromJSONTyped(json, false);
}

export function DemoLicenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DemoLicense {
    if (json == null) {
        return json;
    }
    return {
...
export function DemoLicenseToJSON(json: any): DemoLicense {
    return DemoLicenseToJSONTyped(json, false);
}

export function DemoLicenseToJSONTyped(value?: DemoLicense | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
