...
export function instanceOfTheme(value: object): value is Theme {
    if (!('themeOptions' in value) || value['themeOptions'] === undefined) return false;
    return true;
}
...
export function ThemeFromJSONTyped(json: any, ignoreDiscriminator: boolean): Theme {
    ...
    return {
        ...
        'smallLogoURI': json['smallLogoURI'] == null ? undefined : json['smallLogoURI'],
        'themeOptions': json['themeOptions'],
    };
}
...
export function ThemeToJSONTyped(value?: Omit<Theme, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'smallLogoURI': value['smallLogoURI'],
        'themeOptions': value['themeOptions'],
    };
}
