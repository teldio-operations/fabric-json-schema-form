...
/**
 * Check if a given object implements the GetUsersOutputBody interface.
 */
export function instanceOfGetUsersOutputBody(value: object): value is GetUsersOutputBody {
    if (!('users' in value) || value['users'] === undefined) return false;
    return true;
}

export function GetUsersOutputBodyFromJSON(json: any): GetUsersOutputBody {
    return GetUsersOutputBodyFromJSONTyped(json, false);
}

export function GetUsersOutputBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetUsersOutputBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'users': (json['users'] == null ? null : (json['users'] as Array<any>).map(UserDetailsFromJSON)),
    };
}

export function GetUsersOutputBodyToJSON(json: any): GetUsersOutputBody {
    return GetUsersOutputBodyToJSONTyped(json, false);
}

export function GetUsersOutputBodyToJSONTyped(value?: Omit<GetUsersOutputBody, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'users': (value['users'] == null ? null : (value['users'] as Array<any>).map(UserDetailsToJSON)),
    };
}
