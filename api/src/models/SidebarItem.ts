...
/**
 * Check if a given object implements the SidebarItem interface.
 */
export function instanceOfSidebarItem(value: object): value is SidebarItem {
    if (!('icon' in value) || value['icon'] === undefined) return false;
    if (!('title' in value) || value['title'] === undefined) return false;
    return true;
}

export function SidebarItemFromJSON(json: any): SidebarItem {
    return SidebarItemFromJSONTyped(json, false);
}

export function SidebarItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): SidebarItem {
    if (json == null) {
        return json;
    }
    return {
...
export function SidebarItemToJSON(json: any): SidebarItem {
    return SidebarItemToJSONTyped(json, false);
}

export function SidebarItemToJSONTyped(value?: SidebarItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
