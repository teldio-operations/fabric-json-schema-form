 ...
 */
export interface GetInfoBody {
    [key: string]: any | any;
    /**
     * A URL to the JSON Schema for this object.
     * @type {string}
     * @memberof GetInfoBody
     */
...
/**
 * Check if a given object implements the GetInfoBody interface.
 */
export function instanceOfGetInfoBody(value: object): value is GetInfoBody {
    if (!('accessFromLoopback' in value) || value['accessFromLoopback'] === undefined) return false;
    if (!('changelogMarkdown' in value) || value['changelogMarkdown'] === undefined) return false;
    if (!('managerHost' in value) || value['managerHost'] === undefined) return false;
    if (!('managerPort' in value) || value['managerPort'] === undefined) return false;
    if (!('showInitialiseFlow' in value) || value['showInitialiseFlow'] === undefined) return false;
    if (!('version' in value) || value['version'] === undefined) return false;
    return true;
}

export function GetInfoBodyFromJSON(json: any): GetInfoBody {
    return GetInfoBodyFromJSONTyped(json, false);
}

export function GetInfoBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetInfoBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'accessFromLoopback': json['accessFromLoopback'],
        'changelogMarkdown': json['changelogMarkdown'],
        'managerHost': json['managerHost'],
        'managerPort': json['managerPort'],
        'showInitialiseFlow': json['showInitialiseFlow'],
        'version': json['version'],
    };
}

export function GetInfoBodyToJSON(json: any): GetInfoBody {
    return GetInfoBodyToJSONTyped(json, false);
}

export function GetInfoBodyToJSONTyped(value?: Omit<GetInfoBody, '$schema'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'accessFromLoopback': value['accessFromLoopback'],
        'changelogMarkdown': value['changelogMarkdown'],
        'managerHost': value['managerHost'],
        'managerPort': value['managerPort'],
        'showInitialiseFlow': value['showInitialiseFlow'],
