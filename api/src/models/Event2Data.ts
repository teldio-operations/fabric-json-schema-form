...
import {
    EventMetaFromJSON,
    EventMetaFromJSONTyped,
    EventMetaToJSON,
    EventMetaToJSONTyped,
} from './EventMeta';
...
/**
 * Check if a given object implements the Event2Data interface.
 */
export function instanceOfEvent2Data(value: object): value is Event2Data {
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function Event2DataFromJSON(json: any): Event2Data {
    return Event2DataFromJSONTyped(json, false);
}

export function Event2DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): Event2Data {
    if (json == null) {
        return json;
    }
    return {
        
        'meta': EventMetaFromJSON(json['meta']),
    };
}

export function Event2DataToJSON(json: any): Event2Data {
    return Event2DataToJSONTyped(json, false);
}

export function Event2DataToJSONTyped(value?: Event2Data | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'meta': EventMetaToJSON(value['meta']),
    };
}
