...
/**
 * Check if a given object implements the Queryable interface.
 */
export function instanceOfQueryable(value: object): value is Queryable {
    if (!('mediaType' in value) || value['mediaType'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function QueryableFromJSON(json: any): Queryable {
    return QueryableFromJSONTyped(json, false);
}

export function QueryableFromJSONTyped(json: any, ignoreDiscriminator: boolean): Queryable {
    if (json == null) {
        return json;
    }
    return {
...
export function QueryableToJSON(json: any): Queryable {
    return QueryableToJSONTyped(json, false);
}

export function QueryableToJSONTyped(value?: Queryable | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
