...
/**
 * Check if a given object implements the PerpetualLicense interface.
 */
export function instanceOfPerpetualLicense(value: object): value is PerpetualLicense {
    if (!('configuredModuleLimit' in value) || value['configuredModuleLimit'] === undefined) return false;
    if (!('supportExpiry' in value) || value['supportExpiry'] === undefined) return false;
    return true;
}

export function PerpetualLicenseFromJSON(json: any): PerpetualLicense {
    return PerpetualLicenseFromJSONTyped(json, false);
}

export function PerpetualLicenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PerpetualLicense {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'configuredModuleLimit': json['configuredModuleLimit'],
        'supportExpiry': (new Date(json['supportExpiry'])),
    };
}

export function PerpetualLicenseToJSON(json: any): PerpetualLicense {
    return PerpetualLicenseToJSONTyped(json, false);
}

export function PerpetualLicenseToJSONTyped(value?: PerpetualLicense | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'configuredModuleLimit': value['configuredModuleLimit'],
        'supportExpiry': value['supportExpiry'].toISOString(),
    };
}
