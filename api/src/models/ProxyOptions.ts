...
import {
    SidebarItemFromJSON,
    SidebarItemFromJSONTyped,
    SidebarItemToJSON,
    SidebarItemToJSONTyped,
} from './SidebarItem';
...
export function ProxyOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProxyOptions {
    ...
    return {
            ...
            ...json,
        'sidebarItem': json['sidebarItem'] == null ? undefined : SidebarItemFromJSON(json['sidebarItem']),
        'url': json['url'],
    };
}
...
export function ProxyOptionsToJSONTyped(value?: ProxyOptions | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
            ...
            ...value,
        'sidebarItem': SidebarItemToJSON(value['sidebarItem']),
        'url': value['url'],
    };
}
