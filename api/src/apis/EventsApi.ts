...
export class EventsApi extends runtime.BaseAPI {
     ...
     * Emit event
     */
    async emitEventRaw(requestParameters: EmitEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Event>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling emitEvent().'
            );
        }
        ...
        if (requestParameters['requestBody'] == null) {
            throw new runtime.RequiredError(
                'requestBody',
                'Required parameter "requestBody" was null or undefined when calling emitEvent().'
            );
        }

        const queryParameters: any = {};

        if (requestParameters['targetName'] != null) {
            queryParameters['target-name'] = requestParameters['targetName'];
        }

        if (requestParameters['targetId'] != null) {
            queryParameters['target-id'] = requestParameters['targetId'];
        }

        if (requestParameters['replyToId'] != null) {
            queryParameters['reply-to-id'] = requestParameters['replyToId'];
        }

        if (requestParameters['expectReply'] != null) {
            queryParameters['expect-reply'] = requestParameters['expectReply'];
        }
        ...
        if (requestParameters['moduleID'] != null) {
            headerParameters['Module-ID'] = String(requestParameters['moduleID']);
        }

        if (requestParameters['moduleName'] != null) {
            headerParameters['Module-Name'] = String(requestParameters['moduleName']);
        }
     ...
     * Emit event
     */
    async emitEvent(requestParameters: EmitEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Event | null | undefined > {
        const response = await this.emitEventRaw(requestParameters, initOverrides);
     ...
     */
    async listenEventRaw(requestParameters: ListenEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Event>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling listenEvent().'
            );
        }
        ...
        if (requestParameters['willReply'] != null) {
            queryParameters['will-reply'] = requestParameters['willReply'];
        }
     ...
     * Listen to a specific event
     */
    async listenEvent(requestParameters: ListenEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Event> {
        const response = await this.listenEventRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Listen to events
     */
    async listenEventsRaw(requestParameters: ListenEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Event>> {
        const queryParameters: any = {};
     ...
     * Listen to events
     */
    async listenEvents(requestParameters: ListenEventsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Event> {
        const response = await this.listenEventsRaw(requestParameters, initOverrides);
        return await response.value();
    }
