...
import {
    ErrorModelFromJSON,
    ErrorModelToJSON,
    RestartResponseBodyFromJSON,
    RestartResponseBodyToJSON,
    SetHostAndPortRequestFromJSON,
    SetHostAndPortRequestToJSON,
} from '../models/index';
...
export interface SetHostAndPortOperationRequest {
    setHostAndPortRequest: Omit<SetHostAndPortRequest, '$schema'>;
}
...
export class SettingsApi extends runtime.BaseAPI {
    ...
    async downloadBackupRaw(requestParameters: DownloadBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        if (requestParameters['excludeEvents'] != null) {
            queryParameters['excludeEvents'] = requestParameters['excludeEvents'];
        }
     ...
     * Restart
     */
    async restartRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestartResponseBody>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/api/restart`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RestartResponseBodyFromJSON(jsonValue));
    }

    /**
     * Restart
     */
    async restart(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestartResponseBody> {
        const response = await this.restartRaw(initOverrides);
        return await response.value();
    }
     ...
     * Restore backup
     */
    async restoreBackupRaw(requestParameters: RestoreBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestartResponseBody>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling restoreBackup().'
            );
        }

        const queryParameters: any = {};

        if (requestParameters['protectExistingConfigs'] != null) {
            queryParameters['protectExistingConfigs'] = requestParameters['protectExistingConfigs'];
        }
     ...
     * Restore backup
     */
    async restoreBackup(requestParameters: RestoreBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestartResponseBody> {
     ...
     * Set host and port
     */
    async setHostAndPortRaw(requestParameters: SetHostAndPortOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestartResponseBody>> {
        if (requestParameters['setHostAndPortRequest'] == null) {
            throw new runtime.RequiredError(
                'setHostAndPortRequest',
                'Required parameter "setHostAndPortRequest" was null or undefined when calling setHostAndPort().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SetHostAndPortRequestToJSON(requestParameters['setHostAndPortRequest']),
        }, initOverrides);
     ...
     * Set host and port
     */
    async setHostAndPort(requestParameters: SetHostAndPortOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestartResponseBody> {
        const response = await this.setHostAndPortRaw(requestParameters, initOverrides);
        return await response.value();
    }
