...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async getInfoRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetInfoBody>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetInfoBodyFromJSON(jsonValue));
    }

    /**
     * Get info about the manager
     */
    async getInfo(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetInfoBody> {
     ...
     * Get theming data
     */
    async getThemeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Theme>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/api/info/theme`;
     ...
     * Get theming data
     */
    async getTheme(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Theme> {
